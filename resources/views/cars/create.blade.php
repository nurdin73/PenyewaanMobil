            ...
            <div class="card-body">
              <form action="{{ route('cars.store') }}" method="post">
                ...
                <div class="form-group mb-2">
                  ...
                  <input type="text" name="merk" value="{{ old('merk') }}" class="form-control @error('merk') is-invalid @enderror">
                  @error('merk')
                ...
                <div class="form-group mb-2">
                  ...
                  <input type="text" name="no_plat" value="{{ old('no_plat') }}" class="form-control @error('no_plat') is-invalid @enderror">
                  @error('no_plat')
                      <span class="form-error text-danger">{{ $message }}</span>
                  @enderror
                </div>
                <div class="form-group mb-2">
                  ...
                  <input type="text" name="price_rent_by_day" value="{{ old('price_rent_by_day') }}" class="form-control @error('price_rent_by_day') is-invalid @enderror">
